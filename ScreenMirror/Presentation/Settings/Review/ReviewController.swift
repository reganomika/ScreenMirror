...
final class ReviewController: UIViewController {
    ...
    private enum Constants {
        ...
        static let contentHeight: CGFloat = 567
        
        static let titleFontSize: CGFloat = 24
        static let subtitleFontSize: CGFloat = 18
        static let buttonFontSize: CGFloat = 16
        
        static let subtitleColor = UIColor(hex: "959595")
        ...
        static let imageTopInset: CGFloat = -10
        static let titleBottomOffset: CGFloat = 20
    ...
    private enum Strings {
        static let title = "What do you think of our app?".localized
        static let subtitle = "Tell us what you thought-we’re all ears!".localized
        static let buttonTitle = "Leave a review".localized
        static let closeButtonTitle = "Later".localized
    }
    ...
    private lazy var closeButton = UIButton().apply {
        $0.setTitle(Strings.closeButtonTitle, for: .normal)
        $0.setTitleColor(.init(hex: "959595"), for: .normal)
        $0.titleLabel?.font = .font(weight: .semiBold, size: Constants.buttonFontSize)
    ...
    private func setupConstraints() {
        ...
        feedbackButton.snp.makeConstraints {
            ...
            $0.bottom.equalTo(closeButton.snp.top).offset(-Constants.buttonBottomOffset)
        }
        
        closeButton.snp.makeConstraints {
            $0.bottom.equalToSuperview().inset(adjustedCloseButtonInset())
            $0.height.equalTo(Constants.closeButtonHeight)
            $0.leading.trailing.equalToSuperview().inset(Constants.wideHorizontalInset)
        }
    }
